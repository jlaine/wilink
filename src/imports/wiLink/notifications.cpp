...
#ifdef Q_OS_MAC
    d->trayIcon->setIcon(QIcon(":/images/64x64/wiLink-black.png"));
#else
    d->trayIcon->setIcon(QIcon(":/images/64x64/wiLink.png"));
#endif

    d->trayMenu = new QMenu;
    QAction *action = d->trayMenu->addAction(QIcon(":/images/64x64/close.png"), tr("&Quit"));
